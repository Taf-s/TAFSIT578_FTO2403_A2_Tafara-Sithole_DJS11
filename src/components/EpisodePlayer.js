...
function EpisodePlayer() {
  ...
  return (
    <div className="max-w-5xl max-h-40 mx-auto p-4 rounded-lg sticky bottom-0 z-50 left-0 right-0 bg-customBlack text-white flex flex-col md:flex-row items-center justify-between shadow-lg transition-all duration-300 ease-in-out">
      {currentEpisode ? (
